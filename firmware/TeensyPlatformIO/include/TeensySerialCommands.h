...
namespace SerialCommands
{
    ...
    const char* kRevisionString = "rev";
...
void printSerialHelp()
{
    ...
    printf("%s - Set PCB revision (requires save command afterwards to save to EEPROM). 0 = Rev A, 1 = Rev B\r\n\n",SerialCommands::kRevisionString);
